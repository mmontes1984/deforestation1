...
<body>
    ...
    <div class="mt-5 container px-5">
        <div id="posts-container">
            <div>
                <h2 id="last-posts" style='color: #053525;'>Últimas Postagens</h2>
                <a id='write-post-anchor' class="btn btn-success" href="./create.php" style='background-color: #053525;'>Escrever um post</a>
            </div>
			<br>
            <div id='posts'>
                <?php
